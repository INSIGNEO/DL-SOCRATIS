...
int itkRicianMembershipFunctionTest(int, char* [] )
{
  ...
  using MembershipFunctionType = itk::Statistics::RicianMembershipFunction< MeasurementVectorType >;
  ...
  measurement[0] = 1.5741;

  double trueValue = 0.67;
