...
int itkRicianMixtureModelComponentTest(int argc, char* argv[] )
{
  using PointSetType = itk::PointSet< double, 2 >;
  using DataSampleType = itk::Statistics::PointSetToListSampleAdaptor<PointSetType>;
  using ComponentType = itk::Statistics::RicianMixtureModelComponent<DataSampleType>;
  ...
  /* Preparing the Rician mixture components */
