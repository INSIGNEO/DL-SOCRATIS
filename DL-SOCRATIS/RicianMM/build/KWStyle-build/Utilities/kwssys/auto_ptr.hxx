...
============================================================================*/
#ifndef kwssys_auto_ptr_hxx
#define kwssys_auto_ptr_hxx
...
# define kwssys_AUTO_PTR_REF 0
# define kwssys_AUTO_PTR_CONST const
# define kwssys_AUTO_PTR_CAST(a) cast(a)
#else
# define kwssys_AUTO_PTR_REF 1
# define kwssys_AUTO_PTR_CONST
# define kwssys_AUTO_PTR_CAST(a) a
#endif
...
public:
  ...
  template <class Y>
  auto_ptr(auto_ptr<Y> kwssys_AUTO_PTR_CONST& a) throw():
    x_(kwssys_AUTO_PTR_CAST(a).release())
    {
    }
  ...
  template <class Y>
  auto_ptr& operator=(auto_ptr<Y> kwssys_AUTO_PTR_CONST& a) throw()
    {
    this->reset(kwssys_AUTO_PTR_CAST(a).release());
    return *this;
    }
  ...
  /** Construct from another auto_ptr holding an object of the same
      ...
      auto_ptr.  */
  auto_ptr(auto_ptr kwssys_AUTO_PTR_CONST& a) throw():
    x_(kwssys_AUTO_PTR_CAST(a).release())
    {
    }
  ...
  auto_ptr& operator=(auto_ptr kwssys_AUTO_PTR_CONST& a) throw()
    {
    this->reset(kwssys_AUTO_PTR_CAST(a).release());
    return *this;
    }
