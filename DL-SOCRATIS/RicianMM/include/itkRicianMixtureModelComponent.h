 ...
 *
 *=========================================================================*/
#ifndef itkRicianMixtureModelComponent_h
#define itkRicianMixtureModelComponent_h
...
{
/** \class RicianMixtureModelComponent
 * \brief is a component (derived from MixtureModelComponentBase) for
 * Rician class. This class is used in
...
class ITK_TEMPLATE_EXPORT RicianMixtureModelComponent:
  public MixtureModelComponentBase< TSample >
{
public:
  /**Standard class type aliases. */
  using Self = RicianMixtureModelComponent;
  using Superclass = MixtureModelComponentBase< TSample >;
  using Pointer = SmartPointer< Self >;
  using ConstPointer = SmartPointer< const Self >;

  /**Standard Macros */
  itkTypeMacro(RicianMixtureModelComponent, MixtureModelComponentBase);
  itkNewMacro(Self);
  ...
  /** Type of the membership function. Rician density function */
  using NativeMembershipFunctionType = RicianMembershipFunction<MeasurementVectorType>;
...
protected:
  RicianMixtureModelComponent();
  ~RicianMixtureModelComponent() override {}
...
private:
  typename NativeMembershipFunctionType::Pointer m_RicianMembershipFunction;
...
#include "itkRicianMixtureModelComponent.hxx"
#endif
