 ...
 *
 *=========================================================================*/
#ifndef itkRicianMixtureModelComponent_hxx
#define itkRicianMixtureModelComponent_hxx
...
RicianMixtureModelComponent< TSample >::RicianMixtureModelComponent()
{
  m_MeanEstimator = MeanEstimatorType::New();
  m_CovarianceEstimator = CovarianceEstimatorType::New();
  m_RicianMembershipFunction = NativeMembershipFunctionType::New();
  this->SetMembershipFunction( (MembershipFunctionType *)
                               m_RicianMembershipFunction.GetPointer() );
  m_Mean.Fill(0.0);
  m_Covariance.SetIdentity();
}

template< typename TSample >
void RicianMixtureModelComponent< TSample >::PrintSelf(std::ostream & os, Indent indent) const
{
  ...
  os << indent << "RicianMembershipFunction: " << m_RicianMembershipFunction << std::endl;
}

template< typename TSample >
void RicianMixtureModelComponent< TSample >::SetSample(const TSample *sample)
{
  ...
  m_RicianMembershipFunction->SetMeasurementVectorSize(measurementVectorLength);
  ...
  m_RicianMembershipFunction->SetMean(mean);
}

template< typename TSample >
void RicianMixtureModelComponent< TSample >::SetParameters(const ParametersType & parameters)
{
  ...
  m_RicianMembershipFunction->SetCovariance(m_Covariance);

  this->AreParametersModified(changed);
}

template< typename TSample >
double RicianMixtureModelComponent< TSample >::CalculateParametersChange()
{
  unsigned int i, j;
...
template< typename TSample >
void RicianMixtureModelComponent< TSample >::GenerateData()
{
