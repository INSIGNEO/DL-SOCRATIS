 ...
 *
 *=========================================================================*/
#ifndef itkRicianMembershipFunction_h
#define itkRicianMembershipFunction_h
...
{
/** \class RicianMembershipFunction
 * \brief RicianMembershipFunction models class membership through a
 * multivariate Rician function.
 *
 * RicianMembershipFunction is a subclass of MembershipFunctionBase
 * that models class membership (or likelihood) using a multivariate
 * Rician function. The mean and covariance structure of the
 * Rician are established using the methods SetMean() and
...
class ITK_TEMPLATE_EXPORT RicianMembershipFunction:
  public MembershipFunctionBase< TMeasurementVector >
{
public:
  ITK_DISALLOW_COPY_AND_ASSIGN(RicianMembershipFunction);

  /** Standard class type aliases */
  using Self = RicianMembershipFunction;
  using Superclass = MembershipFunctionBase< TMeasurementVector >;
  using Pointer = SmartPointer< Self >;
  using ConstPointer = SmartPointer< const Self >;

  /** Standard macros */
  itkTypeMacro(RicianMembershipFunction, MembershipFunction);
  itkNewMacro(Self);
  ...
  /** Set the mean of the Rician distribution. Mean is a vector type
   * similar to the measurement type but with a real element type. */
  void SetMean(const MeanVectorType & mean);

  /** Get the mean of the Rician distribution. Mean is a vector type
   * similar to the measurement type but with a real element type. */
   ...
   * matrix and the normlization term for the multivariate Rician
...
protected:
  RicianMembershipFunction();
  ~RicianMembershipFunction() override {}
...
#include "itkRicianMembershipFunction.hxx"
#endif
